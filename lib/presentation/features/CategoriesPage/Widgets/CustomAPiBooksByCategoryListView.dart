...
import 'package:book_app/presentation/features/CategoriesPage/Widgets/CustomApiBooksByCategoryItem.dart';
import 'package:flutter/material.dart';

class CustomAPiBooksByCategoryListView extends StatelessWidget {
  const CustomAPiBooksByCategoryListView(
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return Padding(
          ...
          child: CustomApiBooksByCategoryItem(
